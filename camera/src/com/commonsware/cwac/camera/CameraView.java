...
//           parameters.setGpsProcessingMethod(gpsLocation.getProvider().toUpperCase());
//           if (gpsLocation.hasAltitude()) {
//             parameters.setGpsAltitude(gpsLocation.getAltitude());
//           } else {
...
//             long utcTimeSeconds = gpsLocation.getTime() / 1000;
...
//        }
        Toast.makeText(getActivity(),
                  "new latitude = " + Double.toString(latitude) + " && longitude = " + Double.toString(longitude),
